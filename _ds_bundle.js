  ...
  function App() {
    ...
    const updateAction = (cicloId, tipo, index, patch) => {
      ...
      setCiclos(cs => cs.map(c => {
        ...
        const rows = (c.feedbackForm[key] || []).map((r, i) => i === index ? {
          ...r,
          ...patch
        } : r);
        return {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(window.GestorPanel, {
      ...
      onUpdateAction: updateAction,
      onSaveAvaliacaoForm: saveAvaliacaoForm,
      onSaveFeedbackForm: saveFeedbackForm,
...
(function () {
  ...
  function CicloPrintView({
    ...
    }, fb.conexao || "—"), /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 28,
        paddingTop: 14,
...
// ui_kits/ciclo/ColaboradorHistoricoView.jsx
try { (() => {
...
(function () {
  ...
  function ColaboradorHistoricoView({
    colab,
    gestorNome,
    ciclosDoColab,
    movimentacoes,
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, colab.nome), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "#666"
      }
    }, colab.cargo || "—", colab.demitido ? " · Desligado" : "")), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "#666",
        textAlign: "right"
      }
    }, "Hist\xF3rico do Colaborador", /*#__PURE__*/React.createElement("br", null), "Ciclo de Desenvolvimento e Evolu\xE7\xE3o")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "grid",
        gridTemplateColumns: "1fr 1fr 1fr",
        gap: 12,
      ...
      value: colab.diretoria
    }), /*#__PURE__*/React.createElement(Info, {
      label: "Setor",
      value: colab.setor
    }), /*#__PURE__*/React.createElement(Info, {
      label: "Regional",
      value: colab.regional
    }), /*#__PURE__*/React.createElement(Info, {
      label: "Admiss\xE3o",
      value: fmtDate(colab.admissao) + " · " + tempoEmpresa(colab.admissao, colab.demitido ? colab.demissao : null)
    })), /*#__PURE__*/React.createElement("div", {
      style: {
        background: AZUL,
        color: "#fff",
    ...
    }, "Movimenta\xE7\xF5es (gestor, cargo, \xE1rea)"), movs.length === 0 ? /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "#888",
        marginBottom: 20
      }
    }, "Nenhuma movimenta\xE7\xE3o registrada.") : /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: 8,
    ...
    }, movs.map(m => /*#__PURE__*/React.createElement("div", {
      key: m.id,
      style: {
        borderLeft: "3px solid " + LARANJA,
        paddingLeft: 10,
    ...
    }, m.detalhe || "Cadastro atualizado"), /*#__PURE__*/React.createElement("div", {
      style: {
        color: "#888",
        fontSize: 11
      }
    }, new Date(m.ts).toLocaleString("pt-BR"), " \xB7 por ", m.ator)))), /*#__PURE__*/React.createElement("div", {
      style: {
        background: AZUL,
        color: "#fff",
        padding: "8px 14px",
    ...
    }, "Ciclos de Desenvolvimento"), ciclos.length === 0 ? /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "#888"
      }
    }, "Nenhum ciclo registrado ainda.") : /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: 8
      }
    }, ciclos.map(c => /*#__PURE__*/React.createElement("div", {
      key: c.id,
      style: {
        display: "flex",
        justifyContent: "space-between",
    ...
    }, /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("strong", null, c.cicloNum), " \xB7 aplica\xE7\xE3o ", fmtDate(c.data), " \xB7 prazo ", fmtDate(prazoFinal(c)), " \xB7 ", c.alvo || "—"), /*#__PURE__*/React.createElement("span", {
      style: {
        fontWeight: 700,
        color: c.encerrado ? "#1f8a5b" : "#e07d09"
      }
    }, c.encerrado ? "Encerrado" : statusLabel(c))))), /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 28,
        paddingTop: 14,
        borderTop: "1px solid #e2e7ee",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/ciclo/ColaboradorHistoricoView.jsx", error: String((e && e.message) || e) }); }
...
(function () {
  ...
  function FuncionariosScreen({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      status: "completo",
      label: "Ativo"
    }), ciclosDe(c.id).length > 0 && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 11,
        color: "var(--ab-azul-escuro)",
        background: "var(--surface-brand-soft)",
    ...
    }, ciclosDe(c.id).length, " ciclo(s)")), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "var(--text-muted)",
        marginTop: 4,
    ...
    }, "Excluir")))))), list.filter(c => c.id === histId).map(c => /*#__PURE__*/React.createElement(window.ColaboradorHistoricoView, {
      key: c.id,
      colab: c,
      gestorNome: gestorNome,
      ciclosDoColab: ciclosDe(c.id),
      movimentacoes: movimentacoesDe(c.nome),
...
(function () {
  ...
  function ComparisonModal({
    ...
    return /*#__PURE__*/React.createElement(Modal, {
      ...
      }, "Gerar PDF"), /*#__PURE__*/React.createElement(Button, {
        variant: "primary",
        onClick: onClose
      }, "Fechar"))
    }, /*#__PURE__*/React.createElement("div", {
      ...
      gestor: g.pdiComp,
      colab: co.pdiComp
    }), fb.rowsTec && fb.rowsTec.length > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: 18
      }
    }, /*#__PURE__*/React.createElement("div", {
      ...
      rows: fb.rowsTec,
      readOnly: true
    })), fb.rowsComp && fb.rowsComp.length > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: 18
      }
    }, /*#__PURE__*/React.createElement("div", {
      ...
      rows: fb.rowsComp,
      readOnly: true
    })), fb.conexao && /*#__PURE__*/React.createElement(Banner, {
      tone: "info",
      icon: /*#__PURE__*/React.createElement(Icon, {
        name: "handshake",
        size: 16
...
(function () {
  ...
  function DashboardScreen({
    ...
    const statusPorColaborador = funcionarios.filter(f => !f.demitido).map(f => {
      const ciclosDoFunc = colabs.filter(c => c.funcionarioId === f.id);
      return {
        f,
        status: statusColaboradorCiclo(f.admissao, ciclosDoFunc),
        temCicloAberto: ciclosDoFunc.some(c => !c.encerrado)
      };
    });
    ...
    const vencidos = atrasados.map(c => ({
      ...c,
      dias: diasPara(prazoFinal(c))
    })).sort((a, b) => a.dias - b.dias).slice(0, 6);
    const proximos = colabs.filter(c => !c.encerrado).map(c => ({
      ...c,
      dias: diasPara(prazoFinal(c))
    })).filter(c => c.dias !== null && c.dias >= 0 && c.dias <= 7).sort((a, b) => a.dias - b.dias).slice(0, 6);
    ...
    const rankingDiretoria = paresDiretoria.map(g => {
      ...
      return {
        id: g.id,
        nome: g.nome,
        pct: elegivelG ? Math.round(realizadosG / elegivelG * 100) : 0
      };
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      title: "Taxa de Realiza\xE7\xE3o (Previsto \xD7 Realizado)",
      style: {
        background: "var(--surface-brand-soft)",
        border: "1px solid var(--role-feedback)"
      }
    ...
    }, pctRealizacao, "%"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12.5,
        color: "var(--text-muted)",
        lineHeight: 1.6
      }
    }, /*#__PURE__*/React.createElement("strong", null, realizados), " colaboradores com ciclo em dia de ", /*#__PURE__*/React.createElement("strong", null, totalElegivel), " eleg\xEDveis (j\xE1 passaram 6 meses desde a admiss\xE3o ou desde o \xFAltimo ciclo conclu\xEDdo)."))), /*#__PURE__*/React.createElement(Card, {
      title: "Funil do Ciclo"
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
      ...
      style: {
        height: "100%",
        width: totalElegivel ? `${s.value / totalElegivel * 100}%` : "0%",
        background: s.color,
        borderRadius: 6
      }
    })), /*#__PURE__*/React.createElement("span", {
      ...
      value: pendentesSemAbrir,
      label: "Pendentes sem Ciclo Aberto",
      tone: pendentesSemAbrir > 0 ? "accent" : "default",
      icon: /*#__PURE__*/React.createElement(Icon, {
        name: "user-x",
        size: 20
      })
      ...
      title: "Sua Posi\xE7\xE3o na Diretoria"
    }, gestor && paresDiretoria.length > 0 ? /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        alignItems: "center",
        gap: 18
    ...
    }, minhaPosicao, "\xBA", /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 16,
        color: "var(--text-muted)",
        fontWeight: 600
      }
    }, " de ", paresDiretoria.length)), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12.5,
        color: "var(--text-muted)",
        lineHeight: 1.6
      }
    }, "Diretoria ", /*#__PURE__*/React.createElement("strong", null, diretoriaAtual || "—"), /*#__PURE__*/React.createElement("br", null), "Sua Taxa de Realiza\xE7\xE3o: ", /*#__PURE__*/React.createElement("strong", {
      style: {
        color: pctRealizacao >= mediaDiretoria ? COR_OK : COR_RUIM
      }
    }, pctRealizacao, "%"), " \xB7 M\xE9dia da diretoria: ", mediaDiretoria, "%")) : /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "var(--text-muted)"
      }
    }, "Sem outros gestores na mesma diretoria para comparar ainda.")), /*#__PURE__*/React.createElement(Card, {
    ...
    }, vencidos.map(c => /*#__PURE__*/React.createElement("div", {
      key: c.id,
      style: {
        fontSize: 12,
        padding: "6px 8px",
    ...
    }, /*#__PURE__*/React.createElement("strong", null, c.nome), " \xB7 ", Math.abs(c.dias), " dia(s)")), vencidos.length === 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "var(--text-muted)"
      }
    }, "Nenhum ciclo vencido."))), /*#__PURE__*/React.createElement(Card, {
      title: "Alertas \u2014 Pr\xF3ximos 7 dias"
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
    ...
    }, proximos.map(c => /*#__PURE__*/React.createElement("div", {
      key: c.id,
      style: {
        fontSize: 12,
        padding: "6px 8px",
    ...
    }, /*#__PURE__*/React.createElement("strong", null, c.nome), " \xB7 ", c.dias === 0 ? "vence hoje" : c.dias === 1 ? "vence amanhã" : `vence em ${c.dias} dias`)), proximos.length === 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "var(--text-muted)"
      }
    }, "Nenhum vencimento pr\xF3ximo.")))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "grid",
        gridTemplateColumns: "1fr 1fr",
        gap: 14
      ...
      value: pdiPendentes,
      label: "Pendentes",
      tone: pdiPendentes > 0 ? "accent" : "default",
      icon: /*#__PURE__*/React.createElement(Icon, {
        name: "circle-dashed",
        size: 18
      })
      ...
      title: "Colaboradores Eleg\xEDveis sem Ciclo Encerrado"
    }, semCiclo.length === 0 ? /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "var(--text-muted)"
      }
    }, "Nenhum colaborador eleg\xEDvel aguardando abertura de ciclo.") : /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: 6,
    ...
    }, semCiclo.slice(0, 8).map(f => /*#__PURE__*/React.createElement("div", {
      key: f.id,
      style: {
        display: "flex",
        alignItems: "center",
    ...
    }, /*#__PURE__*/React.createElement("span", null, f.nome), /*#__PURE__*/React.createElement(Button, {
      size: "sm",
      variant: "accent",
      iconLeft: /*#__PURE__*/React.createElement(Icon, {
        name: "calendar-plus",
      ...
      onClick: () => onNavigate && onNavigate("ciclos")
    }, "Cadastrar Ciclo"))), semCiclo.length > 8 && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "var(--text-muted)"
      }
    }, "+ ", semCiclo.length - 8, " outro(s).")))), /*#__PURE__*/React.createElement(Card, {
      ...
      onClick: () => onNavigate && onNavigate("colaboradores")
    }, "Cadastrar Colaborador"), /*#__PURE__*/React.createElement(Button, {
      variant: "secondary",
      iconLeft: /*#__PURE__*/React.createElement(Icon, {
        name: "calendar-plus",
        size: 14
      ...
      onClick: () => onNavigate && onNavigate("ciclos")
    }, "Cadastrar Ciclo"))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "grid",
        gridTemplateColumns: "repeat(4, 1fr)",
        gap: "14px"
      ...
      columns: [{
        ...
        align: "center",
        render: r => /*#__PURE__*/React.createElement(Icon, {
          name: r.avaliacaoForm ? "check-circle-2" : "circle-dashed",
          size: 18,
          color: r.avaliacaoForm ? "var(--positive)" : "var(--ab-gray-400)"
        })
      }, {
        key: "f",
        header: "Feedback",
        align: "center",
        render: r => /*#__PURE__*/React.createElement(Icon, {
          name: r.feedbackForm ? "check-circle-2" : "circle-dashed",
          size: 18,
          color: r.feedbackForm ? "var(--positive)" : "var(--ab-gray-400)"
        })
      }, {
        key: "status",
        header: "Status",
...
// ui_kits/ciclo/FormAvaliacaoScreen.jsx
try { (() => {
  ...
  function FormAvaliacaoScreen({
    ...
    if (!pendentes.length) {
      return /*#__PURE__*/React.createElement(Card, {
        title: "Avalia\xE7\xE3o do Gestor"
      }, /*#__PURE__*/React.createElement("div", {
        style: {
          textAlign: "center",
          padding: 30,
      ...
      }, "Nenhum ciclo em aberto. Cadastre um ciclo na aba ", /*#__PURE__*/React.createElement("strong", null, "Cadastro de Ciclo"), " para poder avaliar."));
    }
    ...
    React.useEffect(() => {
      setForm(fromColab(colabs.find(x => x.id === id) || pendentes[0]));
      setErrs({});
    }, [id]);
    const salvar = () => {
      const faltando = {};
      Object.keys(blankForm()).forEach(k => {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, pendentes.map(x => /*#__PURE__*/React.createElement("option", {
      key: x.id,
      value: x.id
    }, x.nome, x.revenda ? ` — ${x.revenda}` : "", x.avaliacaoForm ? " (já avaliado)" : "", !x.colabForm ? " · autoavaliação pendente" : "")))), /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 14,
        display: "flex",
        flexDirection: "column",
      ...
      hint: "1) Que resultados concretos o colaborador alcan\xE7ou com suas entregas nos \xFAltimos 6 meses? 2) De que forma essas entregas contribu\xEDram para o atingimento dos objetivos da equipe/empresa? 3) Quais desafios ele superou e como isso impactou seus resultados?"
      ...
      hint: "Espero que voc\xEA atinja/entregue tais objetivos at\xE9 x tempo (o que a empresa espera do funcion\xE1rio). O que voc\xEA planeja fazer para alcan\xE7ar? Que recursos voc\xEA acredita ser necess\xE1rios para atingir os objetivos?"
    }, /*#__PURE__*/React.createElement(TextArea, {
      autoGrow: true,
      minRows: 4,
      value: form.futuro,
      ...
      hint: "1) Quais s\xE3o os maiores pontos fortes e a desenvolver do funcion\xE1rio?"
    }, /*#__PURE__*/React.createElement(TextArea, {
      autoGrow: true,
      minRows: 3,
      value: form.pdiTec,
      onChange: e => set("pdiTec", e.target.value),
      placeholder: "Pontos fortes e a desenvolver...",
    ...
    }, "Ao salvar, o status do ciclo muda para ", /*#__PURE__*/React.createElement("strong", null, "Feedback Agendado"), ". O colaborador ainda n\xE3o visualiza sua avalia\xE7\xE3o \u2014 ela s\xF3 \xE9 liberada quando o ciclo for encerrado, ao final da reuni\xE3o de feedback."), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        justifyContent: "flex-end",
        gap: 12
      ...
      onClick: salvar
    }, "Salvar Avalia\xE7\xE3o do Gestor")));
  }
  window.FormAvaliacaoScreen = FormAvaliacaoScreen;
})();
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/ciclo/FormAvaliacaoScreen.jsx", error: String((e && e.message) || e) }); }
...
(function () {
  ...
  function FormColaboradorScreen({
    ...
    if (readOnly) {
      ...
      const roField = (label, val, role) => /*#__PURE__*/React.createElement(Card, {
        spine: role || "colab",
        style: {
          marginBottom: 0
        }
      ...
      return /*#__PURE__*/React.createElement("div", {
      ...
      }, renderHero(`Olá, ${c.nome.split(" ")[0]}! Ciclo encerrado — confira o resultado completo e acompanhe seu PDI.`), /*#__PURE__*/React.createElement("div", {
        style: {
          maxWidth: 820,
          margin: "0 auto",
          padding: "22px 18px",
      ...
      }, "Este \xE9 o Plano de Desenvolvimento Individual acordado na reuni\xE3o de feedback. Marque cada a\xE7\xE3o como ", /*#__PURE__*/React.createElement("strong", null, "realizada"), " e informe a ", /*#__PURE__*/React.createElement("strong", null, "data de conclus\xE3o"), ". Suas atualiza\xE7\xF5es aparecem automaticamente para o seu gestor."), c.alvo && /*#__PURE__*/React.createElement(Banner, {
        tone: "accent",
        icon: /*#__PURE__*/React.createElement(Icon, {
          name: "target",
          size: 16
        ...
        title: "Data da reuni\xE3o de feedback"
      }, fmtDate(c.data)), /*#__PURE__*/React.createElement(SectionTitle, {
        icon: /*#__PURE__*/React.createElement(Icon, {
          name: "refresh-cw",
          size: 15
        })
      }, "Jornada de Reflex\xE3o e Evolu\xE7\xE3o"), roField("Retrospectiva — Percepção do Gestor", av.retro, "gestor"), roField("Retrospectiva — Sua Percepção", d.retro), roField("Foco no Futuro — Percepção do Gestor", av.futuro, "gestor"), roField("Foco no Futuro — Seu Plano", d.futuro), /*#__PURE__*/React.createElement(SectionTitle, {
        highlight: "T\xE9cnico",
        icon: /*#__PURE__*/React.createElement(Icon, {
          name: "wrench",
          size: 15
        })
      }, "PDI"), roField("Percepção do Gestor — Técnico", av.pdiTec, "gestor"), roField("Sua Autoanálise Técnica", d.pdiTec), /*#__PURE__*/React.createElement(SectionTitle, {
        highlight: "Comportamental",
        icon: /*#__PURE__*/React.createElement(Icon, {
          name: "brain",
          size: 15
        })
      }, "PDI"), roField("Percepção do Gestor — Comportamental", av.pdiComp, "gestor"), roField("Sua Autoanálise Comportamental", d.pdiComp), fb.conexao && /*#__PURE__*/React.createElement(Banner, {
        tone: "info",
        icon: /*#__PURE__*/React.createElement(Icon, {
          name: "handshake",
          size: 16
        }),
        title: "Conex\xE3o com o L\xEDder"
      }, fb.conexao), temPdi ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(SectionTitle, {
        highlight: "T\xE9cnico",
        icon: /*#__PURE__*/React.createElement(Icon, {
          name: "wrench",
          size: 15
        })
      }, "Melhoria Acordada"), /*#__PURE__*/React.createElement(Card, null, AcaoTable ? /*#__PURE__*/React.createElement(AcaoTable, {
        rows: fb.rowsTec,
        tipo: "tec",
        colabId: c.id,
      ...
      }, "Nenhuma a\xE7\xE3o de PDI foi registrada neste ciclo."), historico && historico.length > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(SectionTitle, {
        icon: /*#__PURE__*/React.createElement(Icon, {
          name: "history",
          size: 15
        })
      }, "Hist\xF3rico de ciclos anteriores"), /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
        style: {
          display: "flex",
          flexDirection: "column",
          gap: 8
        }
      }, historico.map(h => /*#__PURE__*/React.createElement("div", {
        key: h.id,
        style: {
          display: "flex",
          justifyContent: "space-between",
      ...
      }, /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("strong", null, h.cicloNum), " \xB7 aplica\xE7\xE3o ", fmtDate(h.data)), /*#__PURE__*/React.createElement("span", {
        style: {
          color: "var(--text-muted)"
        }
      }, h.encerrado ? "Encerrado" : "Em andamento")))))), /*#__PURE__*/React.createElement("div", {
        style: {
          display: "flex",
          justifyContent: "space-between",
          alignItems: "center"
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "Preencha os campos referentes \xE0 ", /*#__PURE__*/React.createElement("strong", null, "sua percep\xE7\xE3o como liderado"), ". Ao enviar, seu gestor far\xE1 a avalia\xE7\xE3o dele \u2014 depois voc\xEAs se encontram para a reuni\xE3o de feedback."), c.alvo && /*#__PURE__*/React.createElement(Banner, {
      tone: "accent",
      icon: /*#__PURE__*/React.createElement(Icon, {
        name: "target",
        size: 16
      ...
      hint: "1) Que resultados concretos voc\xEA alcan\xE7ou com suas entregas nos \xFAltimos 6 meses? 2) De que forma essas entregas contribu\xEDram para o atingimento dos objetivos da equipe/empresa? 3) Quais desafios voc\xEA superou para entregar seus objetivos/projetos e como isso impactou seus resultados?"
    }, /*#__PURE__*/React.createElement(TextArea, {
      autoGrow: true,
      minRows: 4,
      value: form.retro,
      ...
      hint: "Espero que voc\xEA atinja/entregue tais objetivos at\xE9 x tempo (o que a empresa espera de voc\xEA). O que voc\xEA planeja fazer para alcan\xE7ar? Que recursos voc\xEA acredita ser necess\xE1rios para atingir os objetivos?"
    }, /*#__PURE__*/React.createElement(TextArea, {
      autoGrow: true,
      minRows: 4,
      value: form.futuro,
      ...
      hint: "O que voc\xEA tem de bom? O que voc\xEA acha que precisa melhorar para atingir a meta?"
    }, /*#__PURE__*/React.createElement(TextArea, {
      autoGrow: true,
      minRows: 3,
      value: form.pdiTec,
    ...
    }, "Grupo \xC1guia Branca \xB7 Divis\xE3o Com\xE9rcio"), /*#__PURE__*/React.createElement(Button, {
      variant: "primary",
      iconLeft: /*#__PURE__*/React.createElement(Icon, {
        name: "check",
        size: 15
...
// ui_kits/ciclo/FormFeedbackScreen.jsx
try { (() => {
...
(function () {
  ...
  function FormFeedbackScreen({
    ...
    if (!pendentes.length) {
      ...
      }, "Nenhum ciclo pronto para a reuni\xE3o de feedback. Ela libera assim que a autoavalia\xE7\xE3o e a avalia\xE7\xE3o do gestor estiverem conclu\xEDdas."));
    }
    const [id, setId] = React.useState(pendentes[0].id);
    const c = colabs.find(x => x.id === id) || pendentes[0];
    const fromColab = cc => {
    ...
    const concluir = () => {
      ...
      if (Object.keys(faltando).length || pdiIncompleto) {
        setErrs(faltando);
        const msg = pdiIncompleto ? "Cada ação de PDI precisa ter Ação e Data Acordada preenchidas." : "Preencha todos os campos antes de concluir (inclusive ao menos uma ação em cada PDI).";
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      highlight: "T\xE9cnica",
      icon: /*#__PURE__*/React.createElement(Icon, {
        name: "wrench",
        size: 15
      })
    }, "Plano de Desenvolvimento Individual \u2014 T\xE9cnica (com base no alvo definido)"), /*#__PURE__*/React.createElement(DualPane, null, /*#__PURE__*/React.createElement(Pane, {
      role: "gestor",
      heading: "Percep\xE7\xE3o do L\xEDder"
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        whiteSpace: "pre-wrap",
        fontSize: 13,
    ...
    }, av.pdiTec || "—")), /*#__PURE__*/React.createElement(Pane, {
      role: "colab",
      heading: "Percep\xE7\xE3o do Liderado"
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        whiteSpace: "pre-wrap",
        fontSize: 13,
    ...
    }, d.pdiTec || "—"))), /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement(Pane, {
      role: "feedback",
      heading: "Melhoria Acordada"
    }, /*#__PURE__*/React.createElement(Field, {
      hint: "1) O que voc\xEA gostaria de aprender ou desenvolver nos pr\xF3ximos meses? 2) Quais conhecimentos t\xE9cnicos est\xE3o faltando para voc\xEA desempenhar suas fun\xE7\xF5es com excel\xEAncia?"
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        height: 4
      }
    ...
    }, "Plano de Desenvolvimento Individual \u2014 Comportamental (com base no alvo definido)"), /*#__PURE__*/React.createElement(DualPane, null, /*#__PURE__*/React.createElement(Pane, {
      role: "gestor",
      heading: "Percep\xE7\xE3o do L\xEDder"
    }, /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, av.pdiComp || "—")), /*#__PURE__*/React.createElement(Pane, {
      role: "colab",
      heading: "Percep\xE7\xE3o do Liderado"
    }, /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, d.pdiComp || "—"))), /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement(Pane, {
      role: "feedback",
      heading: "Melhoria Acordada"
    }, /*#__PURE__*/React.createElement(Field, {
      hint: "1) O que voc\xEA gostaria de aprender ou desenvolver nos pr\xF3ximos meses? 2) Quais comportamentos voc\xEA precisa desenvolver para ter um melhor desempenho?"
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        height: 4
      }
    ...
    }, "Conex\xE3o L\xEDder"), /*#__PURE__*/React.createElement(Card, {
      spine: "gestor"
    }, /*#__PURE__*/React.createElement(Pane, {
      role: "gestor",
      heading: "O que eu, como l\xEDder, posso contribuir para o seu crescimento?"
    }, /*#__PURE__*/React.createElement(TextArea, {
      autoGrow: true,
      minRows: 3,
      value: form.conexao,
    ...
    }, /*#__PURE__*/React.createElement("strong", null, "Este formul\xE1rio encerra o ciclo."), " Ao concluir, o colaborador passa a visualizar toda a avalia\xE7\xE3o do gestor e este acordo, e o PDI entra na fase de acompanhamento."), /*#__PURE__*/React.createElement(Legend, null), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        justifyContent: "flex-end",
        gap: 12
      ...
      onClick: concluir
    }, "Concluir Reuni\xE3o e Encerrar Ciclo")));
  }
  window.FormFeedbackScreen = FormFeedbackScreen;
})();
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/ciclo/FormFeedbackScreen.jsx", error: String((e && e.message) || e) }); }

// ui_kits/ciclo/GestorHistoricoView.jsx
try { (() => {
...
(function () {
  ...
  const AZUL = "#0f4b87",
    LARANJA = "#ff931e";
  function GestorHistoricoView({
    gestor,
    ciclosDoGestor,
    funcionariosDoGestor,
    onClose
  }) {
    ...
    }, gestor.nome), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "#666"
      }
    }, gestor.cargo || "—", " \xB7 ", gestor.diretoria || "—", gestor.desligado ? " · Desligado" : "")), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "#666",
        textAlign: "right"
      }
    }, "Hist\xF3rico do Gestor", /*#__PURE__*/React.createElement("br", null), "Ciclo de Desenvolvimento e Evolu\xE7\xE3o")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: 20,
        marginBottom: 12
    ...
    }, totalElegivel), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "#666",
        textTransform: "uppercase"
      }
    }, "Eleg\xEDveis")), /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1,
        textAlign: "center",
        background: "#fbeaea",
    ...
    }, pendentesElegiveis), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "#666",
        textTransform: "uppercase"
    ...
    }, ciclos.length), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "#666",
        textTransform: "uppercase"
      }
    }, "Total de Ciclos")), /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1,
        textAlign: "center",
        background: "#fff6e9",
    ...
    }, abertos.length), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "#666",
        textTransform: "uppercase"
      }
    }, "Abertos")), /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1,
        textAlign: "center",
        background: "#e7f4ee",
    ...
    }, concluidos.length), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "#666",
        textTransform: "uppercase"
      }
    }, "Conclu\xEDdos"))), listaPendentes.length > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: 20
      }
    }, /*#__PURE__*/React.createElement("div", {
    ...
    }, "Colaboradores Pendentes (", listaPendentes.length, ")"), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: 6
      }
    }, listaPendentes.map(f => /*#__PURE__*/React.createElement("div", {
      key: f.id,
      style: {
        display: "flex",
        justifyContent: "space-between",
    ...
    }, f.cargo || "—"))))), /*#__PURE__*/React.createElement("div", {
      style: {
        background: AZUL,
        color: "#fff",
        padding: "8px 14px",
    ...
    }, "Ciclos Abertos"), abertos.length === 0 ? /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "#888",
        marginBottom: 20
      }
    }, "Nenhum ciclo em aberto.") : /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: 8,
    ...
    }, abertos.map(c => /*#__PURE__*/React.createElement("div", {
      key: c.id,
      style: {
        display: "flex",
        justifyContent: "space-between",
    ...
    }, /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("strong", null, c.nome), " \xB7 ", c.cicloNum, " \xB7 aplica\xE7\xE3o ", fmtDate(c.data), " \xB7 prazo ", fmtDate(prazoFinal(c))), /*#__PURE__*/React.createElement("span", {
      style: {
        fontWeight: 700,
        color: "#e07d09"
      }
    }, statusLabel(c))))), /*#__PURE__*/React.createElement("div", {
      style: {
        background: AZUL,
        color: "#fff",
        padding: "8px 14px",
    ...
    }, "Ciclos Conclu\xEDdos"), concluidos.length === 0 ? /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "#888"
      }
    }, "Nenhum ciclo conclu\xEDdo ainda.") : /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: 8
      }
    }, concluidos.map(c => /*#__PURE__*/React.createElement("div", {
      key: c.id,
      style: {
        display: "flex",
        justifyContent: "space-between",
    ...
    }, /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("strong", null, c.nome), " \xB7 ", c.cicloNum, " \xB7 aplica\xE7\xE3o ", fmtDate(c.data)), /*#__PURE__*/React.createElement("span", {
      style: {
        fontWeight: 700,
        color: "#1f8a5b"
      }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/ciclo/GestorHistoricoView.jsx", error: String((e && e.message) || e) }); }
...
(function () {
  ...
  function GestorPanel({
    ...
    if (colabFormFor) {
      ...
      const historicoColab = ciclosView.filter(x => x.funcionarioId === live.funcionarioId && x.id !== live.id).sort((a, b) => (b.data || "").localeCompare(a.data || ""));
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(window.FormColaboradorScreen, {
        colab: live,
        historico: historicoColab,
        logoSrc: logoSrc,
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      gestor: gestor,
      todosGestores: todosGestores,
      ciclosViewGeral: ciclosViewGeral,
      ...
      colabs: ciclosView,
      onUpdateAction: onUpdateAction
    }), view === "avaliacao" && /*#__PURE__*/React.createElement(window.FormAvaliacaoScreen, {
      colabs: ciclosView,
      onSave: onSaveAvaliacaoForm,
      onToast: toast
    }), view === "feedback" && /*#__PURE__*/React.createElement(window.FormFeedbackScreen, {
      colabs: ciclosView,
      onSave: onSaveFeedbackForm,
      onToast: toast
...
(function () {
  ...
  function acoesVencidas(c) {
    return pdiRows(c).filter(r => !r.done && r.data && diasPara(r.data) < 0).length;
  }
  ...
  function PdiScreen({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      value: vencidos,
      label: "Colaboradores com A\xE7\xF5es Vencidas",
      tone: vencidos > 0 ? "accent" : "default",
      icon: /*#__PURE__*/React.createElement(Icon, {
        name: "alarm-clock",
        size: 20
      })
    ...
    }, "Planos de Desenvolvimento Individual acordados no ciclo. O ", /*#__PURE__*/React.createElement("strong", null, "colaborador"), " atualiza cada a\xE7\xE3o como realizada e registra a ", /*#__PURE__*/React.createElement("strong", null, "data de conclus\xE3o"), " pelo link dele; o ", /*#__PURE__*/React.createElement("strong", null, "gestor"), " acompanha o progresso aqui."), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: 8,
        flexWrap: "wrap",
    ...
    }, ["todas", "pendente", "andamento", "concluido"].map(k => /*#__PURE__*/React.createElement(Button, {
      key: k,
      size: "sm",
      variant: situacao === k ? "primary" : "secondary",
      onClick: () => setSituacao(k)
    }, k === "todas" ? "Todas" : SITUACAO_LABEL[k]))), /*#__PURE__*/React.createElement(Field, {
      label: "Colaborador"
    }, /*#__PURE__*/React.createElement(Select, {
      value: sel,
      ...
      value: "todos"
    }, "Todos os colaboradores (", porSituacao.length, ")"), porSituacao.map(c => /*#__PURE__*/React.createElement("option", {
      key: c.id,
      value: c.id
      ...
      return /*#__PURE__*/React.createElement(Card, {
        ...
        status: pdiSituacao(c) === "concluido" ? "completo" : pdiSituacao(c) === "andamento" ? "parcial" : "pendente",
        label: "PDI " + SITUACAO_LABEL[pdiSituacao(c)]
      }), acoesVencidas(c) > 0 && /*#__PURE__*/React.createElement(StatusBadge, {
        status: "pendente",
        label: `${acoesVencidas(c)} ação(ões) vencida(s)`
      })), c.alvo && /*#__PURE__*/React.createElement(Banner, {
        tone: "accent",
        icon: /*#__PURE__*/React.createElement(Icon, {
          name: "target",
...
// ui_kits/ciclo/PipelineScreen.jsx
try { (() => {
...
(function () {
  ...
  const {
    ...
    PIPELINE_STAGES,
    pipelineStageCiclo,
    pipelineStageSemCiclo,
    ciclosPrevistos
  } = window.CicloHelpers;
  const STAGE_COLOR = {
    pendente: "var(--text-muted)",
    atraso: "var(--danger)",
    criado: "var(--ab-azul-claro)",
    autoaval_pendente: "var(--ab-laranja-600)",
    autoaval_concluida: "var(--ab-azul-claro)",
    gestor_pendente: "var(--ab-laranja-600)",
    avaliacao_concluida: "var(--ab-azul-claro)",
    feedback_agendado: "var(--ab-laranja-600)",
    feedback_realizado: "var(--ab-azul-claro)",
    pdi_criado: "var(--ab-azul-claro)",
    pdi_andamento: "var(--ab-laranja-600)",
    finalizado: "var(--positive)"
  };
  function PipelineScreen({
    funcionarios,
    gestores,
    ciclosView,
    mostrarFiltrosOrg = true
  }) {
    ...
    const cards = (funcionarios || []).filter(f => !f.demitido).map(f => {
      ...
      return {
        ...
        ciclo: atual,
        stage,
        gestor: gestorNome(f.gestorId),
        diretoriaGestor: gestorDiretoria(f.gestorId)
      };
    }).filter(x => (!diretoria || x.diretoriaGestor === diretoria) && (!regional || x.ciclo && x.ciclo.orgRegional === regional) && (!unidade || x.ciclo && x.ciclo.orgUnidade === unidade) && (!setor || x.f.setor === setor) && (!gestorId || x.f.gestorId === gestorId) && (!periodo || x.ciclo && x.ciclo.data && x.ciclo.data.slice(0, 7) === periodo));
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "Cada card representa o colaborador na etapa mais avan\xE7ada do seu ciclo atual. Role horizontalmente para ver todas as ", PIPELINE_STAGES.length, " etapas."), mostrarFiltrosOrg && /*#__PURE__*/React.createElement(FilterBar, null, /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1,
        minWidth: 150
      }
      ...
      value: ""
    }, "Todas as regionais"), regionais.map(r => /*#__PURE__*/React.createElement("option", {
      key: r,
      value: r
      ...
      value: ""
    }, "Todas as unidades"), unidades.map(u => /*#__PURE__*/React.createElement("option", {
      key: u,
      value: u
      ...
      value: ""
    }, "Todos os setores"), setores.map(s => /*#__PURE__*/React.createElement("option", {
      key: s,
      value: s
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          ...
          fontWeight: 700,
          color: "#fff",
          background: STAGE_COLOR[stage.key],
          borderRadius: 999,
          padding: "1px 8px"
        }
      ...
      }, x.f.nome), /*#__PURE__*/React.createElement("div", {
        style: {
          fontSize: 11,
          color: "var(--text-muted)"
        }
      }, x.gestor, x.ciclo ? ` · ${fmtDate(x.ciclo.data)}` : ""))))));
    })));
  }
  window.PipelineScreen = PipelineScreen;
})();
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/ciclo/PipelineScreen.jsx", error: String((e && e.message) || e) }); }
...
(function () {
  ...
  function RhColaboradoresScreen({
    ...
    const abrirEdicao = c => {
      ...
      setEditForm({
        gestorId: c.gestorId,
        cargo: titleCase(c.cargo || ""),
        departamento: titleCase(c.departamento || ""),
        diretoria: titleCase(c.diretoria || ""),
        setor: titleCase(c.setor || ""),
        regional: titleCase(c.regional || "")
      });
    };
    const salvarEdicao = c => {
      const gestorAntigo = gestorNome(c.gestorId);
      onUpdate(c.id, editForm);
      if (editForm.gestorId !== c.gestorId) onToast(`${c.nome} transferido de ${gestorAntigo} para ${gestorNome(editForm.gestorId)}. Histórico de ciclos preservado.`, "success");else onToast("Cadastro atualizado.", "success");
      setEditId(null);
      setEditForm(null);
    };
    const cadastrar = () => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      action: /*#__PURE__*/React.createElement(Button, {
        ...
        onClick: () => window.CicloBulk.exportRows(list, [{
          label: "Nome",
          key: "nome"
        }, {
          label: "Gestor",
          value: r => gestorNome(r.gestorId)
        }, {
          label: "Cargo",
          key: "cargo"
        }, {
          ...
          label: "Admissão",
          value: r => fmtDate(r.admissao)
        }, {
          label: "Ciclos",
          value: r => ciclosDe(r.id).length
        }, {
          label: "Status",
          value: r => r.demitido ? "Desligado" : "Ativo"
    ...
    }))), editId === c.id && editForm && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 12,
        padding: 12,
        background: "var(--surface-sunken)",
      ...
      key: g.id,
      value: g.id
    }, g.nome)))), /*#__PURE__*/React.createElement(Field, {
      label: "Cargo"
    }, /*#__PURE__*/React.createElement(TextField, {
      value: editForm.cargo,
      onChange: e => setEditForm(s => ({
    ...
    }, "Salvar"))), histId === c.id && /*#__PURE__*/React.createElement(window.ColaboradorHistoricoView, {
      colab: c,
      gestorNome: gestorNome(c.gestorId),
      ciclosDoColab: ciclosDe(c.id),
      movimentacoes: movimentacoesDe(c.nome),
      onClose: () => setHistId(null)
    })), /*#__PURE__*/React.createElement("div", {
      ...
      size: "sm",
      variant: "ghost",
      onClick: () => setHistId(histId === c.id ? null : c.id),
      iconLeft: /*#__PURE__*/React.createElement(Icon, {
        name: "history",
        size: 14
      })
...
// ui_kits/ciclo/RhDashboardPrintView.jsx
try { (() => {
...
(function () {
  ...
  const COR_OK = "#1f8a5b",
    ...
    COR_RUIM = "#c81e28";
  function corPct(p) {
    return p >= 80 ? COR_OK : p >= 50 ? COR_ALERTA : COR_RUIM;
  }
  function Kpi({
    value,
    label
  ...
  function RhDashboardPrintView({
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "Ciclo de Desenvolvimento e Evolu\xE7\xE3o \u2014 Vis\xE3o Geral do RH"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "#666",
        marginTop: 2
      }
    }, "Filtros aplicados: ", filtrosResumo || "nenhum")), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "#666",
        textAlign: "right"
      }
    }, "Gerado em ", new Date().toLocaleDateString("pt-BR"), /*#__PURE__*/React.createElement("br", null), "Grupo \xC1guia Branca \xB7 Divis\xE3o Com\xE9rcio")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: 12,
        flex: "0 0 auto"
      ...
      value: d.colaboradoresAtivos,
      label: "Colaboradores Ativos"
    }), /*#__PURE__*/React.createElement(Kpi, {
      value: d.gestoresAtivos,
      label: "Gestores Ativos"
    }), /*#__PURE__*/React.createElement(Kpi, {
      value: d.pendentesSemAbrir,
      label: "Pendentes sem Ciclo Aberto"
    }), /*#__PURE__*/React.createElement(Kpi, {
      value: d.realizados,
      label: "Ciclo Realizado"
    }), /*#__PURE__*/React.createElement(Kpi, {
      value: d.pctRealizacao + "%",
      label: "Taxa de Realiza\xE7\xE3o"
    })), /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1,
        minHeight: 0,
      ...
      title: "Funil do Ciclo e Indicadores"
    }, [{
      label: "Elegíveis",
      value: d.totalElegivel,
      color: "#0f7cb9"
    }, {
      label: "Iniciados",
      value: d.iniciadosPessoas,
      color: COR_ALERTA
    }, {
      label: "Concluídos",
      value: d.realizados,
      ...
      style: {
        height: "100%",
        width: d.totalElegivel ? `${s.value / d.totalElegivel * 100}%` : "0%",
        background: s.color,
        borderRadius: 6
      }
    })), /*#__PURE__*/React.createElement("span", {
    ...
    }, "Conclus\xE3o do Ciclo", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", {
      style: {
        fontSize: 20,
        color: corPct(d.pctConclusaoCiclo)
      }
    }, d.pctConclusaoCiclo, "%")), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 13
      }
    }, "Gestores em Dia", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", {
      style: {
        fontSize: 20,
        color: corPct(d.pctGestoresEmDia)
      }
    }, d.pctGestoresEmDia, "%")))), /*#__PURE__*/React.createElement(Quadrant, {
      title: "Diretoria \xD7 Realiza\xE7\xE3o",
      color: AZUL
    }, /*#__PURE__*/React.createElement("table", {
      style: {
        width: "100%",
    ...
    }, "Diretoria"), /*#__PURE__*/React.createElement("th", {
      style: {
        padding: "4px 6px"
      }
    }, "Eleg."), /*#__PURE__*/React.createElement("th", {
      style: {
        padding: "4px 6px"
      }
    ...
    }, "%"))), /*#__PURE__*/React.createElement("tbody", null, (d.diretoriaData || []).slice(0, 6).map(x => {
      ...
      }, x.label), /*#__PURE__*/React.createElement("td", {
        style: {
          padding: "5px 6px"
        }
      }, x.value), /*#__PURE__*/React.createElement("td", {
        style: {
          padding: "5px 6px"
        }
      }, x.concluidos), /*#__PURE__*/React.createElement("td", {
        style: {
          padding: "5px 6px"
        }
      }, /*#__PURE__*/React.createElement("span", {
    ...
    }), (!d.diretoriaData || d.diretoriaData.length === 0) && /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", {
      colSpan: 4,
      style: {
        padding: 10,
        color: "#888"
      }
    }, "Sem dados."))))), /*#__PURE__*/React.createElement(Quadrant, {
      title: "Melhor Taxa de Realiza\xE7\xE3o",
      color: COR_OK
    }, (d.melhores || []).length === 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "#888"
      }
    }, "Sem dados suficientes."), (d.melhores || []).slice(0, 5).map(x => /*#__PURE__*/React.createElement("div", {
      key: x.g.id,
      style: {
        display: "flex",
        justifyContent: "space-between",
    ...
    }, /*#__PURE__*/React.createElement("span", null, x.g.nome), /*#__PURE__*/React.createElement("strong", {
      style: {
        color: COR_OK
      }
    }, x.pct, "%")))), /*#__PURE__*/React.createElement(Quadrant, {
      title: "Mais Pend\xEAncias",
      color: COR_RUIM
    }, (d.piores || []).filter(x => x.pendG > 0).length === 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "#888"
      }
    }, "Nenhuma pend\xEAncia."), (d.piores || []).filter(x => x.pendG > 0).slice(0, 5).map(x => /*#__PURE__*/React.createElement("div", {
      key: x.g.id,
      style: {
        display: "flex",
        justifyContent: "space-between",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/ciclo/RhDashboardPrintView.jsx", error: String((e && e.message) || e) }); }
...
(function () {
  ...
  const AZUL = "var(--ab-azul-escuro)",
    LARANJA = "var(--ab-laranja)";
  const COR_OK = "#1f8a5b",
    COR_ALERTA = "#e07d09",
    COR_RUIM = "#c81e28";
  function corPct(p) {
  ...
  function normKey(v) {
    return titleCase(v).normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase();
  }
  function Bar({
    pct,
    label,
  ...
  function Donut({
    ...
    }, Math.round(segments[0]?.pct || 0), "%")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: 8
  ...
  function BarChart({
    ...
    }, d.value, suffix || ""))), data.length === 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "var(--text-muted)"
      }
  ...
  function Sparkline({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        width: "100%",
        maxWidth: 28,
        height: Math.max(4, d.value / m * 78),
        background: "var(--ab-azul-claro)",
  ...
  function RhDashboardScreen({
    ...
    (gestores || []).forEach(g => {
      if (g.diretoria) diretoriaLabel[normKey(g.diretoria)] = titleCase(g.diretoria);
    });
    ...
    previsaoPorColaborador.forEach(x => {
      ...
      if (!porDiretoria[d]) porDiretoria[d] = {
        previstos: 0,
        concluidos: 0
      };
    ...
    const diretoriaData = Object.keys(porDiretoria).map(d => ({
      label: diretoriaLabel[d] || d,
      value: porDiretoria[d].previstos,
      concluidos: porDiretoria[d].concluidos
    })).sort((a, b) => b.value - a.value);

    // Ciclos por unidade (colaboradores elegíveis pendentes + realizados).
    const unidadeLabel = {};
    (gestores || []).forEach(g => {
      if (g.unidade) unidadeLabel[normKey(g.unidade)] = titleCase(g.unidade);
    });
    const gestorUnidade = gid => {
      const g = gestorObj(gid);
      return g ? normKey(g.unidade) : "";
    };
    const porUnidade = {};
    previsaoPorColaborador.forEach(x => {
    ...
    const unidadeData = Object.keys(porUnidade).map(u => ({
      label: unidadeLabel[u] || u,
      value: porUnidade[u].previstos ? Math.round(porUnidade[u].concluidos / porUnidade[u].previstos * 100) : 0
    })).sort((a, b) => b.value - a.value);
    ...
    const evolucaoData = mesesOrdenados.map(m => ({
      label: new Date(m + "-01T00:00:00").toLocaleDateString("pt-BR", {
        month: "short"
      }),
      value: porMes[m]
    }));
    ...
    // Alertas.
    const vencidos = abertosAtrasados.map(c => ({
      ...c,
      dias: diasPara(prazoFinal(c))
    })).sort((a, b) => a.dias - b.dias).slice(0, 10);
    const proximos = rows.filter(c => !c.encerrado).map(c => ({
      ...c,
      dias: diasPara(prazoFinal(c))
    })).filter(c => c.dias !== null && c.dias >= 0 && c.dias <= 7).sort((a, b) => a.dias - b.dias).slice(0, 8);
    ...
    previsaoPorColaborador.forEach(x => {
      if (x.status === "realizado" || x.status === "pendente") previstoPorGestor[x.f.gestorId] = (previstoPorGestor[x.f.gestorId] || 0) + 1;
    });
    ...
    const rankingGestores = gestoresFiltrados.map(g => {
      ...
      return {
        g,
        pct: previstoG ? Math.round(realizadosG / previstoG * 100) : 0,
        pendG,
        totalG,
        previstoG
      };
    ...
    const filtrosResumo = [diretoria && `Diretoria: ${diretoria}`, departamento && `Departamento: ${departamento}`, regional && `Regional: ${regional}`, unidade && `Unidade: ${unidade}`, gestorId && `Gestor: ${gestorNome(gestorId)}`, periodo && `Período: ${periodo}`].filter(Boolean).join(" · ");
    const dadosPrint = {
      colaboradoresAtivos: colaboradoresAtivosLista.length,
      gestoresAtivos: gestoresFiltrados.length,
      pendentesSemAbrir,
      realizados,
      pctRealizacao,
      totalElegivel,
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement(FilterBar, null, /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1,
        minWidth: 140
      }
      ...
      value: ""
    }, "Todos os departamentos"), departamentos.map(d => /*#__PURE__*/React.createElement("option", {
      key: d,
      value: d
    }, d)))), /*#__PURE__*/React.createElement("div", {
      style: {
      ...
      value: colaboradoresAtivosLista.length,
      label: "Colaboradores Ativos",
      icon: /*#__PURE__*/React.createElement(Icon, {
        name: "users",
        size: 20
      ...
      value: gestoresFiltrados.length,
      label: "Gestores Ativos",
      icon: /*#__PURE__*/React.createElement(Icon, {
        name: "shield",
        size: 20
      ...
      value: realizados,
      label: "Colaboradores com Ciclo Realizado",
      tone: "default",
      icon: /*#__PURE__*/React.createElement(Icon, {
        name: "check-circle-2",
        size: 20
      ...
      label: "Taxa de Conclus\xE3o do Ciclo (iniciado \u2192 conclu\xEDdo)",
      value: pctConclusaoCiclo + "%",
      pct: pctConclusaoCiclo,
      color: corPct(pctConclusaoCiclo)
    }), /*#__PURE__*/React.createElement(Bar, {
      label: "Eleg\xEDveis sem Ciclo Encerrado",
      value: pendentesElegiveis,
      pct: totalElegivel ? Math.round(pendentesElegiveis / totalElegivel * 100) : 0,
      color: corPct(100 - (totalElegivel ? Math.round(pendentesElegiveis / totalElegivel * 100) : 0))
    }), /*#__PURE__*/React.createElement(Bar, {
      label: "Gestores em Dia",
      value: pctGestoresEmDia + "%",
      pct: pctGestoresEmDia,
      color: corPct(pctGestoresEmDia)
    }), /*#__PURE__*/React.createElement(Bar, {
      label: "Gestores com Atraso",
      value: pctGestoresAtraso + "%",
      pct: pctGestoresAtraso,
      color: corPct(100 - pctGestoresAtraso)
    }))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "grid",
        gridTemplateColumns: "1fr 1fr",
      ...
      title: "% Previsto \xD7 Realizado por Unidade"
    }, /*#__PURE__*/React.createElement(BarChart, {
      data: unidadeData.slice(0, 6),
      max: 100,
      suffix: "%"
    })), /*#__PURE__*/React.createElement(Card, {
      title: "Ciclos por Diretoria"
    }, /*#__PURE__*/React.createElement(BarChart, {
      data: diretoriaData.slice(0, 6)
    }))), /*#__PURE__*/React.createElement(Card, {
      title: "Diretoria \xD7 Ciclos (Heatmap)"
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        overflowX: "auto"
      }
    ...
    }, "Eleg\xEDveis"), /*#__PURE__*/React.createElement("th", {
      style: {
        padding: "6px 8px"
      }
    }, "Realizados"), /*#__PURE__*/React.createElement("th", {
      style: {
        padding: "6px 8px"
      }
    }, "Pendentes"), /*#__PURE__*/React.createElement("th", {
      style: {
        padding: "6px 8px"
      }
    }, "% Realiza\xE7\xE3o"))), /*#__PURE__*/React.createElement("tbody", null, diretoriaData.map(d => {
      ...
      }, d.value), /*#__PURE__*/React.createElement("td", {
        style: {
          padding: "8px"
        }
      }, d.concluidos), /*#__PURE__*/React.createElement("td", {
        style: {
          padding: "8px"
        }
      }, pend), /*#__PURE__*/React.createElement("td", {
        style: {
          padding: "8px"
        }
      }, /*#__PURE__*/React.createElement("span", {
    ...
    }), diretoriaData.length === 0 && /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", {
      colSpan: 5,
      style: {
        padding: 16,
        textAlign: "center",
    ...
    }, "Sem dados.")))))), /*#__PURE__*/React.createElement(Card, {
    ...
    }, "\uD83D\uDD34 Ciclos Vencidos"), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: 6,
    ...
    }, /*#__PURE__*/React.createElement("strong", null, c.nome), " \xB7 ", Math.abs(c.dias), " dia(s)", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
      style: {
        color: "var(--text-muted)"
      }
    }, "Resp.: ", c.gestor || "—"))), vencidos.length === 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "var(--text-muted)"
      }
    }, "Nenhum ciclo vencido."))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        fontWeight: 700,
        color: COR_ALERTA,
    ...
    }, "\uD83D\uDFE0 Pr\xF3ximos Vencimentos (7 dias)"), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: 6,
    ...
    }, "Nenhum vencimento pr\xF3ximo."))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        fontWeight: 700,
        color: "#b7791f",
    ...
    }, "\uD83D\uDFE1 Eleg\xEDveis sem Ciclo Encerrado"), liberados.length > 0 ? /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12.5,
        padding: "10px",
        border: "1px solid var(--border-subtle)",
    ...
    }, liberados.length, " colaborador(es) completaram 6 meses e ainda n\xE3o t\xEAm ciclo encerrado.", /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 8
      }
    }, /*#__PURE__*/React.createElement(Button, {
      ...
      variant: "accent",
      onClick: () => onNavigate && onNavigate("colaboradores")
    }, "Ver colaboradores"))) : /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "var(--text-muted)"
      }
    }, "Nenhum colaborador pendente.")))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "grid",
        gridTemplateColumns: "1fr 1fr",
        gap: 16
      ...
      title: "Gestores com Melhor Taxa de Realiza\xE7\xE3o"
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
    ...
    }, melhores.map(x => /*#__PURE__*/React.createElement("div", {
      key: x.g.id,
      style: {
        display: "flex",
        alignItems: "center",
    ...
    }, x.g.nome), /*#__PURE__*/React.createElement("strong", {
      style: {
        color: COR_OK
      }
    }, x.pct, "%"))), melhores.length === 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "var(--text-muted)"
      }
    }, "Sem dados suficientes."))), /*#__PURE__*/React.createElement(Card, {
      title: "Gestores com Mais Pend\xEAncias"
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
    ...
    }, piores.filter(x => x.pendG > 0).map(x => /*#__PURE__*/React.createElement("div", {
      key: x.g.id,
      style: {
        display: "flex",
        alignItems: "center",
    ...
    }, x.pendG))), piores.filter(x => x.pendG > 0).length === 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "var(--text-muted)"
      }
    }, "Nenhuma pend\xEAncia."))))), /*#__PURE__*/React.createElement(Card, {
      title: "A\xE7\xF5es R\xE1pidas"
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
      ...
      onClick: () => onNavigate && onNavigate("gestores")
    }, "Novo Gestor"), /*#__PURE__*/React.createElement(Button, {
      variant: "secondary",
      iconLeft: /*#__PURE__*/React.createElement(Icon, {
        name: "user-plus",
        size: 14
      ...
      onClick: () => onNavigate && onNavigate("colaboradores")
    }, "Novo Colaborador"), /*#__PURE__*/React.createElement(Button, {
      variant: "ghost",
      iconLeft: /*#__PURE__*/React.createElement(Icon, {
        name: "upload",
        size: 14
      ...
      onClick: () => onNavigate && onNavigate("gestores")
    }, "Importar Gestores"), /*#__PURE__*/React.createElement(Button, {
      variant: "ghost",
      iconLeft: /*#__PURE__*/React.createElement(Icon, {
        name: "upload",
        size: 14
      ...
      onClick: () => onNavigate && onNavigate("colaboradores")
    }, "Importar Colaboradores"), /*#__PURE__*/React.createElement(Button, {
      variant: "accent",
      iconLeft: /*#__PURE__*/React.createElement(Icon, {
        name: "file-down",
        size: 14
      ...
      onClick: exportar
    }, "Exportar Dashboard"), /*#__PURE__*/React.createElement(Button, {
      variant: "secondary",
      iconLeft: /*#__PURE__*/React.createElement(Icon, {
        name: "presentation",
        size: 14
    ...
    }, "Gerar PDF (One Pager)"))), /*#__PURE__*/React.createElement(Card, {
      title: "Controle Unificado \u2014 Gestor \xD7 Colaborador"
    }, /*#__PURE__*/React.createElement(FilterBar, null, /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 2,
      ...
      value: qTabela,
      onChange: e => setQTabela(e.target.value),
      style: {
        paddingLeft: 32
      }
    })), /*#__PURE__*/React.createElement("div", {
      ...
      value: statusTabela,
      onChange: e => setStatusTabela(e.target.value)
    }, /*#__PURE__*/React.createElement("option", {
      value: ""
    }, "Todos os status"), /*#__PURE__*/React.createElement("option", {
      value: "completo"
    ...
    })), printOpen && /*#__PURE__*/React.createElement(window.RhDashboardPrintView, {
...
(function () {
  ...
  function RhGestoresScreen({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      action: /*#__PURE__*/React.createElement(Button, {
        ...
        onClick: () => window.CicloBulk.exportRows(list, [{
          ...
          label: "Colaboradores",
          value: r => qtdColabs(r.id)
        }, {
          label: "Status",
          value: r => r.desligado ? "Desligado" : "Ativo"
        }], "gestores.xlsx", "Gestores")
      }, "Exportar (Excel)")
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        position: "relative",
    ...
    }, "Excluir")))))), gestores.filter(g => g.id === histId).map(g => /*#__PURE__*/React.createElement(window.GestorHistoricoView, {
      key: g.id,
      gestor: g,
      ciclosDoGestor: (ciclos || []).filter(c => c.funcionarioGestorId === g.id),
      funcionariosDoGestor: (funcionarios || []).filter(f => f.gestorId === g.id),
      onClose: () => setHistId(null)
    })));
  }
...
const PIPELINE_STAGES = [{
  ...
  key: "atraso",
  label: "Ciclo em Atraso"
}, {
  key: "criado",
  label: "Ciclo Criado"
}, {
  key: "autoaval_pendente",
  label: "Autoavaliação Pendente"
}, {
  key: "autoaval_concluida",
  label: "Autoavaliação Concluída"
}, {
  key: "gestor_pendente",
  label: "Avaliação do Gestor Pendente"
}, {
  key: "avaliacao_concluida",
  label: "Avaliação Concluída"
}, {
  key: "feedback_agendado",
  label: "Feedback Agendado"
}, {
  key: "feedback_realizado",
