...
(function () {
  ...
  function RhAdminApp({
    ...
    onAddFuncionario, onDeleteFuncionario, onImportFuncionariosBulk,
    ...
    return (
      <div style={{ minHeight: "100vh", background: "var(--surface-canvas)" }}>
        ...
        <main style={{ maxWidth: "var(--container-max)", margin: "0 auto", padding: "24px" }}>
          {view === "dashboard" && <RhDashboardScreen colabs={ciclosView} gestores={gestores} funcionarios={funcionarios} />}
          {view === "gestores" && <window.RhGestoresScreen gestores={gestores} funcionarios={funcionarios} catalogos={catalogos} onAddCatalogoItem={onAddCatalogoItem} onAdd={onAddGestor} onUpdate={onUpdateGestor} onDelete={onDeleteGestor} onImportBulk={onImportGestoresBulk} onToast={toast} />}
          {view === "colaboradores" && <window.RhColaboradoresScreen funcionarios={funcionarios} gestores={gestores} ciclos={ciclosView} catalogos={catalogos} onAddCatalogoItem={onAddCatalogoItem} onAdd={onAddFuncionario} onDelete={onDeleteFuncionario} onImportBulk={onImportFuncionariosBulk} onToast={toast} />}
